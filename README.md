...
- [`1.14.2`, `1.14`, `latest`  (*1.14/Dockerfile*)](https://github.com/peter-evans/osrm-backend-docker/tree/master/1.14)
- [`1.14.2-trusty`, `1.14-trusty`, `trusty`  (*1.14/trusty/Dockerfile*)](https://github.com/peter-evans/osrm-backend-docker/tree/master/1.14/trusty)
